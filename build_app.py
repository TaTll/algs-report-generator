...
function renderPanel(g){
  ...
  h+='<button class="view-btn'+(currentView==="teams"?" active":"")+'" onclick="currentView=\'teams\';renderPanel(\''+g+'\');">Team Data</button>';
  h+='<button class="view-btn'+(currentView==="players"?" active":"")+'" onclick="currentView=\'players\';renderPanel(\''+g+'\');">Player Data</button></div>';
  ...
  h+='<button class="view-btn'+(playerMode==="radar"?" active":"")+'" onclick="playerMode=\'radar\';renderPanel(\''+g+'\');">Radar Charts</button></div>';
