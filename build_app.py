...
function renderPanel(g){
  ...
  h+='<button class="view-btn'+(currentView==="teams"?" active":"")+'" id="btn-teams">Team Data</button>';
  h+='<button class="view-btn'+(currentView==="players"?" active":"")+'" id="btn-players">Player Data</button></div>';
  
  // Teams
  h+='<div class="view-panel'+(currentView==="teams"?" active":"")+'" id="view-teams"><div class="table-wrap"><table><thead><tr><th>#</th><th>Team</th><th>G</th><th>Kills</th><th>Damage</th><th></th></tr></thead><tbody>';
  ...
  // Players
  h+='<div class="view-panel'+(currentView==="players"?" active":"")+'" id="view-players">';
  h+='<div class="sub-bar">';
  h+='<button class="view-btn'+(playerMode==="list"?" active":"")+'" id="btn-list">List</button>';
  h+='<button class="view-btn'+(playerMode==="radar"?" active":"")+'" id="btn-radar">Radar Charts</button></div>';
  
  // List
  h+='<div class="view-panel'+(playerMode==="list"?" active":"")+'" id="pmode-list"><div class="table-wrap"><table><thead><tr><th>#</th><th>Player</th><th>Team</th><th>K</th><th>A</th><th>Dmg</th><th>K/D</th><th>KA/D</th><th>KP%</th></tr></thead><tbody>';
  ...
  // Radar grid
  h+='<div class="view-panel'+(playerMode==="radar"?" active":"")+'" id="pmode-radar"><div class="radar-grid">';
  ...
  panel.innerHTML=h;
  document.getElementById("btn-teams").onclick=function(){currentView="teams";renderPanel(g);};
  document.getElementById("btn-players").onclick=function(){currentView="players";renderPanel(g);};
  try{document.getElementById("btn-list").onclick=function(){playerMode="list";renderPanel(g);};}catch(e){}
  try{document.getElementById("btn-radar").onclick=function(){playerMode="radar";renderPanel(g);};}catch(e){}
}
